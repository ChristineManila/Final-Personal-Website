function getToKnow() {
	...
	switch(favcolor) {
		...
		case "red":
			...
			break;
		case "blue":
			ans1 = "That is also my secondary favorite color!";
			break;
		default:
	...
	if(document.getElementById('agegroup1').checked) {
		...
		ans2 = "We are not in the same age group, but you are a young urban professional!";
	}else if(document.getElementById('agegroup3').checked) {
		ans2 = "We are not in the same age group, but you are at the prime of life!";
	}else if(document.getElementById('agegroup4').checked) {
